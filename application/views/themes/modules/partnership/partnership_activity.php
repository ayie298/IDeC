<script>
	$(function(){
	   ...
	   var source = {
		...
		url: "<?php echo base_url(); ?>partnership/partnership_action/partnership_activity_json",
		cache: false,
		...
		{		
			...
			columns: [
				...
				{ text: 'Activity / Program', datafield: 'program', columntype: 'textbox', filtertype: 'textbox', width: '17%' },
				...
				{ text: 'PIC IDeC', datafield: 'pic_idec', columntype: 'textbox', filtertype: 'textbox', width: '15%' },
				{ text: 'Realisasi', datafield: 'progress', columntype: 'textbox', filtertype: 'textbox', width: '8%' }
           ]
		});
...
<div id="popup_activity" style="display:none">
	<div id="popup_title">Program / Activity</div>
	<div id="popup_content">
			...
			<tr>
				<td colspan="3" style="font-size:16px;font-weight:bold">Add / Edit Activity</td>
			</tr>
			<tr>
				<td width='25%'>Program / Activity</td>
				<td width='1%'>:</td>
				<td class="white">
...
<div>
	<div style="width:99%;background-color:#DDDDDD;-moz-border-radius:5px;border-radius:5px;padding:2px;border:3px solid #ebebeb;">
		<?php if($this->session->userdata('level')!="researcher"){?><div style="float:right;padding:2px">
			<button style='width:250px' id='btn_add_activity' type='button'>Add Activity</button>
		</div><?php }?>
