	...
	public function index($id = null)
	{
		if($_POST) {
			...
			$data = array(
				...
				'program_description'		=> $this->input->post('desc'),
				...
				'id_employee_po'			=> !empty($po) ? $po->id_employee : 0,
				'id_employee_pm'			=> !empty($pm) ? $pm->id_employee : 0,
				'id_annual_data'			=> 0,
				'show_on_review'			=> 0,
				'id_mas_project_status'		=> $this->input->post('status'),
				'id_mas_research_type'		=> 4,
			...
			if($this->form_validation->run() === TRUE) {
				...
				$data['notice'] = 'Program has been ' . $msg;
