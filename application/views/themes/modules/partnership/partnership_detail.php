		...
		$("#bar_rms").click();
 		<?php if($this->session->userdata('level')!="researcher"){?>
			...
			$('#btn_edit').click(function () {
				document.location.href="<?php echo base_url();?>idec_rms/partnership_edit";
			});
		<?php } ?>
...
<div id="popup" style="display:none">
	<div id="popup_title">Partnership </div><div id="popup_content">{popup}</div>
</div>
<div class="row-fluid">
   <div class="span12">
	   <h3 class="page-title">
...
<div style="width:99%;background-color:#DDDDDD;-moz-border-radius:5px;border-radius:5px;padding:2px;border:3px solid #ebebeb;">
    ...
    <tr valign='top'>
        ...
        <td width='1%'>:</td>
        <td width='40%' class="white">Partnership, TEL 35 / HK 810/DC-00/2014</td>
