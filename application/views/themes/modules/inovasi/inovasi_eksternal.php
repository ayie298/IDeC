<script>
    $(function(){
       ...
       var source = {
        ...
        url: "<?php echo base_url(); ?>inovasi/inovasi_eksternal/json",
        cache: false,
        ...
        {       
            ...
            columns: [
                ...
                { text: 'Kategori', datafield: 'kategori', columntype: 'textbox', filtertype: 'textbox', width: '23%' },
                { text: 'Tim Startup', datafield: 'tim', columntype: 'textbox', filtertype: 'textbox', width: '13%' },
                { text: 'Tanggal Pengajuan', datafield: 'tgl', columntype: 'date', filtertype: 'date', cellsformat: 'yyyy/MM/dd', width: '10%' },
        ...
        document.location.href="<?php echo base_url();?>inovasi/inovasi_eksternal/add";
        });

    });

    function detail(id){
        document.location.href="<?php echo base_url();?>inovasi/inovasi_eksternal/detail/"+id;
    }

    function edit(id){
        document.location.href="<?php echo base_url();?>inovasi/inovasi_eksternal/edit/"+id;
    }
...
<div class="row-fluid">
   <div class="span12">
       <h3 class="page-title">
         <i class='icon-tasks'></i> Data Hasil Inovasi Eksternal
       </h3>
   </div>
</div>
...
<div>
    <div class="div-grid">
        ...
        <div style="float:left;position:relative;width:190px;padding-left:20px">
            Tim Startup : <input type="text" name="Tim" placeholder="Nama Tim" style="width:180px;height:28px">
        </div>
