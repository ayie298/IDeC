<script>
	$(function(){
	   ...
	   var source = {
		...
		url: "<?php echo base_url(); ?>partnership/partnership_list/json",
		cache: false,
		...
		{		
			...
			columns: [
				...
				{ text: 'Title', datafield: 'title', columntype: 'textbox', filtertype: 'textbox', width: '28%' },
				{ text: 'Mitra', datafield: 'partner', columntype: 'textbox', filtertype: 'textbox', width: '20%' },
				{ text: 'Status', datafield: 'status', columntype: 'textbox', filtertype: 'textbox', width: '20%' },
				{ text: 'Initiator', datafield: 'org_name', columntype: 'textbox', filtertype: 'textbox', width: '20%' }
            ]
		});
		...
		$('#clearfilteringbutton').click(function () {
 		...
 		$('#refreshdatabutton').click(function () {
			...
			$.post("<?php echo site_url('partnership/partnership_list');?>", 'unit='+value+'&year='+year, function(response) {
				$("#jqxgrid").jqxGrid('updatebounddata', 'cells');
			});
		});

 		$('#btn_add').click(function () {
		document.location.href="<?php echo base_url();?>partnership/partnership_action/add";
		});

	});

	function detail(id){
		document.location.href="<?php echo base_url();?>partnership/partnership_action/detail/"+id;
	}

	function edit(id){
		document.location.href="<?php echo base_url();?>partnership/partnership_action/edit/"+id;
	}
...
<div id="popup" style="display:none"><div id="popup_title">Partnership</div><div id="popup_content">{popup}</div></div>
<div>
